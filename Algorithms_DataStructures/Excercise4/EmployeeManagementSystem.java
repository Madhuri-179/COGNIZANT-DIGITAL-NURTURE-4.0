...
public class EmployeeManagementSystem {
    ...
    public boolean deleteEmployeeById(int employeeId) {
        ...
        System.out.println("Employee with ID " + employeeId + " not found in list.");
        return false;
    }
    ...
    public static void main(String[] args) {
        ...
        system.addEmployee(new Employee(101, "Swaps", "Manager", 75000));
        system.addEmployee(new Employee(102, "Mads", "Developer", 60000));
        system.addEmployee(new Employee(103, "Bhushs", "Designer", 55000));
        system.addEmployee(new Employee(104, "Madddy", "Engineer", 50000));
        ...
        system.addEmployee(new Employee(105, "Kiddo", "Support", 45000));
        system.addEmployee(new Employee(106, "Flora", "Intern", 30000)); // Should fail because capacity is 5
    }
}